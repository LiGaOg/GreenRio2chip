...
#MARGIN 0.9/0.65/1.0
set MARGIN 0.9 
set period_50m [expr $MARGIN      *  20];

#**************************************************************
# List clk ports
#**************************************************************
set CLK_PORT_LIST_IN "clk"
set RST_PORT_LIST_IN "rstn"
...
set period_main_clock $period_50m
...
# Set I/O Delay
#**************************************************************
set_input_delay   [expr 0.5 * $clk_period] -max -clock main_clk [remove_from_collection [all_inputs] [get_ports clk]]
set_input_delay   [expr 0.0 * $clk_period] -min -clock main_clk [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay  [expr 0.5 * $clk_period] -max -clock main_clk [all_outputs]
set_output_delay  [expr 0.0 * $clk_period] -max -clock main_clk [all_outputs]
...
set_ideal_network [get_attribute [get_clocks -filter "full_name !~ main*"] source]
set_dont_touch_network [get_clocks -filter "full_name !~ main*"]
