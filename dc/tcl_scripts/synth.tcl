...
#license is needed#
set_app_var target_library [concat "$DB(ss_n40C_1v76)"]
...
analyze -format  sverilog [concat [expand_file_list "/work/stu/yinguohua/RVH1/updatervh1/rvh1/flist/frontend.syn.f"]]
#analyze -format  sverilog [concat [expand_file_list "$env(PROJ_ROOT)/hardware/design/rtl/flist/rrv64_core_syn.f"]]
